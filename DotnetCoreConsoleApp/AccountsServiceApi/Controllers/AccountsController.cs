...
namespace AccountsServiceApi.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            return identityModels[identityModels.FindIndex(x => x.Name == name)];
        }
        ...
        {
            //update
            identityModels[identityModels.FindIndex(x => x.Name == name)] = value;
        ...
        public void Delete(string name)
        {
            ...
            identityModels.RemoveAt(identityModels.FindIndex(x => x.Name == name));
